        ...
        <div class="container">
            ...
            <div id="services" class="container-fluid text-center bg-grey">
                ...
                <div class="row slideanim">
                    <div class="col-sm-4">
                        <h3>VMapper <a href="#" onClick="window.open('/tools/vmapper')"><span class="glyphicon glyphicon-new-window"></span></a></h3>
                        <p>Help create your route map between your raw data and ICASA standard</p>
                    </div>
                    <div class="col-sm-4">
                        <h3>Unit Master <a href="#" onClick="window.open('/tools/unit')"><span class="glyphicon glyphicon-new-window"></span></a></h3>
