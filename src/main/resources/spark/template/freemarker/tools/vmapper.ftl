                                ...
                                for (let i = 0; i < totColCnt; i++) {
                                    ...
                                    if (!headerDef || matchedMap[i] || !headerDef.column_index_org || headerDef.column_header !== headers[i]) {
                                        for (let j in tableDef.mappings) {
                                            if (!matchedMap[j] && tableDef.mappings[j].column_index_org && tableDef.mappings[j].column_header === headers[i] && (i === tableDef.mappings[j].column_index_org - 1 || tableDef.mappings[j].column_header !== headers[tableDef.mappings[j].column_index_org - 1])) {
