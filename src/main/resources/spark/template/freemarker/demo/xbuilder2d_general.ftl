        ...
        <div id="output_file_group" class="form-group has-feedback col-sm-12">
            ...
            <fieldset class="col-sm-4">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="">
                        ...
                        <input type="hidden" id="exname" value="">
                    </div>
                </div>
            </fieldset>
            <fieldset id="output_file_group" class="col-sm-8">
                ...
                <div class="form-group">
                    ...
                    <textarea rows="2" id="people" name="people" class="form-control" placeholder="Locally used name for experiment" data-toggle="tooltip" title="Locally used name for experiment"></textarea>
                </div>
                <div class="form-group">
                    <label class="control-label" for="address">Address</label>
                    <textarea rows="2" id="address" name="address" class="form-control" placeholder="Locally used name for experiment" data-toggle="tooltip" title="Locally used name for experiment"></textarea>
                </div>
                <div class="form-group">                    
                    <label class="control-label" for="site_name">Site</label>
                    <textarea rows="2" id="site_name" name="site_name" class="form-control" placeholder="Locally used name for experiment" data-toggle="tooltip" title="Locally used name for experiment"></textarea>
                </div>
            </fieldset>
