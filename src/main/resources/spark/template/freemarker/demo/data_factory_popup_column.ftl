                ...
                subDiv.find("[name='unit']").each(function () {
                    ...
                    $(this).on("input", function () {
                        if ($(this).val() === "" && subDiv.find("[name='icasa_unit']").val() !== "") {
                            ...
                            $.get("${env_path_web_root}${env_path_web_data.getUNIT_CONVERT()}?value_from=3&unit_to=" + encodeURIComponent(subDiv.find("[name='icasa_unit']").val()) + "&unit_from="+ encodeURIComponent($(this).val()),
                                function (jsonStr) {
